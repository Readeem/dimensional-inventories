...
public abstract class ModuleGroup
{
    ...
    protected final void register( final Class<? extends Module>... moduleTypes )
        throws ResourceLocationException, InvalidModuleException, ModuleConstructionException
    {
    ...
    private void register( final Module... modules )
        throws ResourceLocationException, InvalidModuleException
    {
        for ( final Module module : modules )
        {
            if ( !ModuleRegistry.isValidId( module.moduleId() ) )
            {
                throw new ResourceLocationException( "'%s' is not a valid module ID".formatted( module.moduleId() ) );
            }
